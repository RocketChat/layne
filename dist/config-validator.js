...
function validateGlobal(block, ctx, errors) {
    ...
    if (block['notifications'] !== undefined)
        validateNotifications(block['notifications'], `${ctx}.notifications`, errors);
    if (block['labels'] !== undefined)
        validateLabels(block['labels'], `${ctx}.labels`, errors);
    if (block['trigger'] !== undefined)
        validateTrigger(block['trigger'], `${ctx}.trigger`, errors);
    if (block['comment'] !== undefined)
        validateComment(block['comment'], `${ctx}.comment`, errors);
    if (block['exceptionApprovers'] !== undefined)
        validateExceptionApprovers(block['exceptionApprovers'], `${ctx}.exceptionApprovers`, errors);
}
function validateRepo(block, ctx, errors) {
    ...
    validateScanMode(block, ctx, errors);
    if (block['semgrep'] !== undefined)
        validateScanner(block['semgrep'], `${ctx}.semgrep`, errors);
    if (block['trufflehog'] !== undefined)
        validateScanner(block['trufflehog'], `${ctx}.trufflehog`, errors);
    if (block['claude'] !== undefined)
        validateClaude(block['claude'], `${ctx}.claude`, errors);
    if (block['notifications'] !== undefined)
        validateNotifications(block['notifications'], `${ctx}.notifications`, errors);
    if (block['labels'] !== undefined)
        validateLabels(block['labels'], `${ctx}.labels`, errors);
...
function validateScanner(block, ctx, errors) {
    ...
    if (b['extraArgs'] !== undefined) {
        ...
        else if (b['extraArgs'].some(a => typeof a !== 'string'))
...
function validateClaude(block, ctx, errors) {
    ...
    if (b['skill'] !== undefined && b['skill'] !== null) {
        if (typeof b['skill'] !== 'object' || Array.isArray(b['skill'])) {
            ...
            const skill = b['skill'];
            if (typeof skill['id'] !== 'string' || !skill['id'].startsWith('skill_'))
...
function validateTrigger(block, ctx, errors) {
    ...
    if (on === 'workflow_job') {
        ...
        else if (typeof b['job'] !== 'string' || b['job'].trim() === '')
    ...
    if (b['conclusions'] !== undefined) {
        ...
        else if (b['conclusions'].length === 0)
...
function validateNotifications(block, ctx, errors) {
    ...
    for (const [provider, cfg] of Object.entries(block)) {
        ...
        if (typeof cfg !== 'object' || cfg === null) {
            errors.push(`${pctx}: must be an object`);
            continue;
        }
        const c = cfg;
...
function validateLabels(block, ctx, errors) {
    ...
    for (const key of ['onFailure', 'removeOnFailure', 'onSuccess', 'removeOnSuccess', 'onException']) {
        ...
        else if (b[key].some(l => typeof l !== 'string'))
...
function validateExceptionApprovers(block, ctx, errors) {
    ...
    if (b['users'] !== undefined) {
        ...
        else if (b['users'].some(u => typeof u !== 'string'))
    ...
    if (b['teams'] !== undefined) {
        ...
        else if (b['teams'].some(t => typeof t !== 'string'))
